...
(defalias 'rx-char-p (if (featurep 'xemacs) 'characterp 'intererp))
...
(if (fboundp 'regexp-opt)
    (defalias 'rx-regexp-opt 'regexp-opt)
  (defun rx-regexp-opt (strings &optional paren)
...
(if (fboundp 'delete-dups)
    (defalias 'rx-delete-dups 'delete-dups)
  (defun rx-delete-dups (list)
